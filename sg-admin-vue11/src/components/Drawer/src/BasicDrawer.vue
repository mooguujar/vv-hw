<template>
  <Drawer :class="[prefixCls, $props.drawerType]" @close="onClose" v-bind="getBindValues">
    ...
    .ant-drawer-header-title {
      ...
      button {
        ...
        span::before{
          ...
          height: 24px;
          background-size: 100%;
          background-image: url('/@/assets/images/site-drawer-collapse.webp');
        }
        svg {
          display: none;
        }
      ...
      //button{
      //  border:1px solid red!important;float: right;}
    }
    .ant-drawer-body {
      .scrollbar__wrap {
        padding: 0!important;

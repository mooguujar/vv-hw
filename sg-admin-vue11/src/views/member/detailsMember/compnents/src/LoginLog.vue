<template>
  <div class="loginLog">
    <Title :name="$t('table.member.member_login_log')" />
...
<script setup lang="ts">
  ...
  import { logColumns, schemasLoginForm, dateGroupButtonList } from '../../details.data';
  ...
  const [registerTable, { getForm, reload }] = useTable({
    ...
    beforeFetch: (param) => {
      ...
      param['timezone'] = userStore.defaultTimezone;
      if (fromSearch.value) {

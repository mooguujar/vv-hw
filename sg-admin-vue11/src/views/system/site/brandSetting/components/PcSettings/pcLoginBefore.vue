            ...
            <div style="margin-left: 100px">
              <div class="pc-setting-box-item">
                ...
                >
                  ...
                  >
                    <div>{{ $t('table.promotion.promotion_login') }}</div>
                    <div
                      class="bg flex items-center justify-center ml-20px"
                      :style="{
                        backgroundColor: getSettingStyle(currentTpl, 'pc_logo_white', 'btnBgColor'),
                        color: getSettingStyle(currentTpl, 'pc_logo_white', 'color1'),
                      }"
                      >{{ t('table.promotion.promotion_regis') }}</div
                    >
                    <img
...
<script setup lang="ts">
  ...
  let schemas: FormSchema[] = [
    {
      ...
      label:
        props.type == 'white'
          ? t('table.system.system_before_logging_in')
          : props.type == 'gray'
  ...
  // 删除
  function handleRemovePcLogUpload() {
    pcLogImg.value = '';
    pcLogfileList.value = [];
    pcLogSetDefault.value = true;
  ...
  async function handleSubmit() {
    ...
    if (props.type == 'white') params['field'] = 'pc_logo_white';

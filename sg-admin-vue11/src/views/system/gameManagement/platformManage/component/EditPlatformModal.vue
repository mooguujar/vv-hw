...
<script lang="ts">
  ...
  import { platformFormSchema } from '../platformManage.data';
  import { useFormSetting } from '/@/hooks/setting/useFormSetting';
  import { updatePlatform } from '/@/api/sys/index';
    ...
    setup(_, { emit }) {
      ...
      async function handleSubmit() {
        try {
          ...
          const { data, status } = await updatePlatform({ ...record, ...values });
          if (status) {

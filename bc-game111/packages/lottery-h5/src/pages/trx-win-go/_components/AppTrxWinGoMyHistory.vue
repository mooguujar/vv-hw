<script setup lang="ts" name="AppTrxWinGoMyHistory">
...
import AppTrxWinGoDetailItem from './AppTrxWinGoDetailItem.vue'
...
<template>
  <div class="win-go">
    <div class="w-full bg-white p-[12rem] rounded-[8rem]">
      <div class="w-full text-right flex justify-end" @click="push('/trx-win-go/detail')">
      ...
      <div v-if="isLogin">
        <AppTrxWinGoDetailItem v-model:is-clear="isClear" :data="sourceData" />
      </div>

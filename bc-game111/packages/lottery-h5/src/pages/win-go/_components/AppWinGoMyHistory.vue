<script setup lang="ts" name="AppWinGoMyHistory">
...
import AppWinGoDetailItem from './AppWinGoDetailItem.vue'
...
<template>
  <div class="win-go">
    <div class="w-full bg-white p-[12rem] rounded-[8rem]">
      <div class="w-full text-right flex justify-end" @click="push('/win-go/detail')">
      ...
      <div v-if="isLogin">
        <AppWinGoDetailItem v-model:is-clear="isClear" :data="sourceData" />
      </div>

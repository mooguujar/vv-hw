...
import { GAMES_LIST, useBlackJack } from 'feie-ui'
...
defineOptions({
  name: 'AppMiniGamePartBlackJackFairVerify',
})
...
const { result } = useBlackJack(params)
...
<template>
  <div>
    ...
    <div class="flex-col-16 bg-tg-secondary-dark flex flex-col p-[16rem]">

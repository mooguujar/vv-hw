...
<template>
  ...
  <!-- 计算明细 -->
  <div v-if="!hasResult" class="flex-col-16 min-h-200 flex flex-col items-center justify-center rounded-[4rem] p-16">
    <div class="ani-roll">
      <IconChessFrame2 />
    </div>
  </div>
  ...
  <template v-if="hasResult">
    ...
    >
      <div class="w-full">
        ...
        <div class="scroll-x flex-row-8 flex flex-row pb-[8rem]">

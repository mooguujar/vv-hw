...
<template>
  <div>
    ...
    <div class="flex-col-16 flex flex-col p-[16rem]">
      <div
        class="border-tg-secondary text-left min-h-[200rem] flex flex-col items-center justify-center border-[2rem] rounded-[8rem] border-dotted p-[16rem]"
      >
        <!-- no result -->
    ...
    <div class="flex-col-16 bg-tg-secondary-dark theme-border flex flex-col p-[16rem]">

...
const selectedPeriod = ref('昨天')
const dateRange = ref('2024-12-18 到 2024-12-25')
const commissionType = ref('直属佣金')
...
const typeOptions = ref<OptionItem[]>([
  { label: '直属佣金', value: '直属佣金' },
  { label: '团队佣金', value: '团队佣金' },
])
...
function selectType(option: OptionItem): void {
  commissionType.value = option.value
        ...
        <div class="popup-content">
          ...
          <div class="popup-inner">
            <div
              ...
              :key="option.value"
              class="select-option"
              :class="{ active: option.value === commissionType }"
              @click="selectType(option)"
            >
              {{ option.label }}
              <div class="circle-container">
                <div v-if="option.value === commissionType" class="select-indicator" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="stats-card">
        <div class="stats-row">
          ...
          <div class="stats-value">
            {{ statsData.validBet.toFixed(2) }}
          </div>
          <div class="stats-currency">
            <BaseCurrencyIcon cur="USDT" />
          </div>
        </div>
        ...
        <div class="stats-row">
          <div>
            ...
            <div class="flex items-center">
              <div class="earned-value">
                {{ statsData.earnedCommission.toFixed(2) }}
              </div>
          ...
          <div class="earned-icon mr-4">
            <BaseImage style="width: 56px;" url="/img/h5/affiliate-program/team-commission-img.png" />
          </div>
        </div>
      </div>
    </div>

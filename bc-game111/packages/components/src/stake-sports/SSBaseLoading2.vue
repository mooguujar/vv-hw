...
defineOptions({ name: 'SSBaseLoading2' })
</script>
...
.animate-prop {
  height: 16rem;
  width: 16rem;
  animation-timing-function: cubic-bezier(0.5, 1.8, 0.2, 2.2);
